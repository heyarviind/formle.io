...
// PrepareVerificationEmailBody ...
func PrepareVerificationEmailBody(email, uid string) string {
	htmlBody := `
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="m_-7751771597802085424bodycopy" style="color:#3e416d;font-family:helvetica;font-size:18px;line-height:1.5">
                          ...
                          <!-- Real info here -->
                          <a href="https://api.formle.io/verify/` + uid + `">https://api.formle.io/verify/` + uid + `</a>
...
// PrepareLimitEmailBody ...
func PrepareLimitEmailBody() string {
	htmlBody := `
	<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
                ...
                <tbody><tr>
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="m_-7751771597802085424bodycopy" style="color:#3e416d;font-family:helvetica;font-size:18px;line-height:1.5">
                          You have crossed your limit cap, please upgrade your plan by <a href="https://formle.io/pricing">clicking here</a>
                          <br><br>
